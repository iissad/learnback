...
import 'package:learnback/features/matching/presentation/screens/match_profile_screen.dart';
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/home/verify-skill/:skillId',
        builder: (context, state) {
          final skillId = state.pathParameters['skillId']!;
          final skillName = state.uri.queryParameters['name'] ?? 'Skill';
          return VerificationQuizScreen(skillId: skillId, skillName: skillName);
        },
      ),
      GoRoute(
        path: '/home/verify-result',
        builder: (context, state) {
      ...
      GoRoute(
        path: '/matching/match-profile/:matchId',
        builder: (context, state) {
          final match = state.extra as MatchResult;
          return MatchProfileScreen(match: match);
        },
      ),
    ],
  );
